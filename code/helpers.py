...
"""
def runTests(numIterations:tuple, features:int, examplesPerAnimal:int, rootDir:str, featureSelectionMode:int, randomBound:int = 0, weightsUsed:int = 0, sigma:int = 90):
    results = {}
    outputs = None
